...
# ---------
DEFAULT_ORGAN_REGENERATOR_APP_NAME = "ROKIT ORS"
DEFAULT_ORGAN_REGNERATOR_DISPLAY_NAME = "ROKIT ORS"
DEFAULT_ORGAN_REGNERATOR_VERSION = "1.0"
DEFAULT_ORGAN_REGNERATOR_BUILD_TYPE = ""
DEFAULT_ORGAN_REGNERATOR_DEBUG_MODE = False
...
try:
    ...
    if CuraAppName == "":
        CuraAppName = DEFAULT_ORGAN_REGENERATOR_APP_NAME
except ImportError:
    CuraAppName = DEFAULT_ORGAN_REGENERATOR_APP_NAME
...
try:
    ...
    if CuraVersion == "":
        CuraVersion = DEFAULT_ORGAN_REGNERATOR_VERSION
except ImportError:
    CuraVersion = DEFAULT_ORGAN_REGNERATOR_VERSION  # [CodeStyle: Reflecting imported value]
...
try:
    ...
    CuraBuildType = DEFAULT_ORGAN_REGNERATOR_BUILD_TYPE

try:
    from cura.CuraVersion import CuraDebugMode  # type: ignore
except ImportError:
    CuraDebugMode = DEFAULT_ORGAN_REGNERATOR_DEBUG_MODE
...
try:
    ...
    if CuraAppDisplayName == "":
        CuraAppDisplayName = DEFAULT_ORGAN_REGNERATOR_DISPLAY_NAME

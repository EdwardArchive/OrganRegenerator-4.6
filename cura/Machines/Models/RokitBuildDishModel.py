...
class RokitBuildDishModel(ListModel):
    ...
    def __init__(self, parent = None):
        ...
        item_list = []
        item_list.append({"product_id": "Well Plate:96", "shape": "elliptic", "volume": QVector3D(6.92, 6.92, 8.0), "travel": {"number_of_rows":96/8, "spacing":9.00, "hop_height": 30.0, "start_point": QPointF(-31.5,49.5), "number_of_walls": 96}})
        item_list.append({"product_id": "Well Plate:48", "shape": "elliptic", "volume": QVector3D(9.75, 9.75, 8.0), "travel": {"number_of_rows":48/6, "spacing":12.90, "hop_height": 30.0, "start_point": QPointF(-32.25,45.15), "number_of_walls": 48}})
        item_list.append({"product_id": "Well Plate:24", "shape": "elliptic", "volume": QVector3D(15.5, 15.5, 8.0), "travel": {"number_of_rows":24/4, "spacing":19.30, "hop_height": 30.0, "start_point": QPointF(-28.95,48.25), "number_of_walls": 24}})

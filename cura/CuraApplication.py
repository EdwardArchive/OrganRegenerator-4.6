...
from cura.Machines.Models.RokitSettingVisibilityPresetsModel import SettingVisibilityPresetsModel
...
class CuraApplication(QtApplication):
    ...
    def startSplashWindowPhase(self) -> None:
        ...
        self.setRequiredPlugins([
            # Misc.:
            "RokitUpdateChecker", #UM에서 복사한걸 사용하려고
    ...
    def runWithGUI(self):
        ...
        camera_tool.setZoomRange(0.1, 80000)
        ...
        # Initialize UI state
        controller.setActiveStage("RokitPrepareStage")

...
class CrashHandler:
    ...
    def _createEarlyCrashDialog(self):
        ...
        label = QLabel()
        label.setText(catalog.i18nc("@label crash message", """<p><b>Oops, ROKIT ORS has encountered something that doesn't seem right.</p></b>
        ...
        self._send_report_checkbox = QCheckBox(catalog.i18nc("@action:button", "Send crash report to Rokit Biohealth"), dialog)
